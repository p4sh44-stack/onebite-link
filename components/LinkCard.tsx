...
export default function LinkCard({ title, url, description, folder, thumbnail }: LinkCardProps) {
  ...
  return (
    <a
      ...
      className="flex flex-col bg-[var(--card-bg)] border border-[var(--border)] rounded-lg card-hover transition-colors overflow-hidden"
    >
